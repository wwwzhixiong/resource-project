  ...
  <div id="myPrint" class="dashboard-container">
    <div class="app-container">
      <el-card>
        ...
        <!-- 打印按钮  v-print 是插件里面的自定义指令，可以将指定的区域进行打印-->
...
export default {
  data() {
    return {
      ...
      formData: {},
      userId: this.$route.params.id, // 路由传参的时候路由地址后面通过：拼接动态参数，用params接受
      type: this.$route.query.type // 打印类型 在跳转路由地址的时候用“?”拼接参数传递的因此用query接受
    }
  },
  // 创建完毕状态
  created() {
